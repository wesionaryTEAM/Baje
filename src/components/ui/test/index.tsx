...
function App() {
  ...
  //     "gta sj j sk sgdjhsl ajdhg fsjhadg jsasdbf ,sdhg fj,sd ,fg sdjhf sdjhf sdjh fsjh sdjh jsd jshdg jsdhg jsdh gjsd vjsdbv sjmb gsaj dvcjhsdv sdjskj gsdjh vmsdg hdvsdgnbvjsdvb jhmvg bsjdhgsdhvhs",
  //   ]);

  //   const handleSend = () => {
  //     inputMessage && setMessages([...messages, inputMessage]);
  //     setInputMessage("");
  //   };
  ...
  return (
    ...
    //   <Sidebar />
    //   <div classNameName="flex flex-1 flex-col space-y-10 mb-10 ">
    //     <div classNameName=" h-12 bg-slate-800">
    //       <div classNameName="p-4">
    //         <h3 classNameName="  text-center align text-white">
    //           What do you wish to know?
    //         </h3>
    //       </div>
    //     </div>
    //     <div classNameName="h-full overflow-auto">
    //       <div classNameName=" mx-40">
    //         <ChatBubble messages={messages} replies={replies} />
    //       </div>
    //     </div>

    //     <div classNameName="mx-40 flex items-end space-x-6">
    //       <Textarea
    //         value={inputMessage}
